import { closestCenter, createSortable, DragDropProvider, DragDropSensors, DragEventHandler, DragOverlay, Id, SortableProvider, useDragDropContext } from "@thisbeyond/solid-dnd";
...
export function SortableList<T>({ items: [items, setItems], id, children }: { items: Signal<T[]>, id: (item: T, index: number) => Id, children: (item: T, index: number) => JSX.Element }) {
