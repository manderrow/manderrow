...
) callconv(.c) rs.InitStatusCode;

pub const send_exit = fn (code: i32, with_code: bool) callconv(.c) void;

pub const send_crash = fn (msg_ptr: [*]const u8, msg_len: usize) callconv(.c) void;
